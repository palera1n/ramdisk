...
if [ "$oscheck" = 'Darwin' ]; then
    ...
    if [ ! "$2" = 'rootless' ]; then
        ...
        mv palera1n.zip work/palera1n.zip
                unzip work/palera1n.zip -d work/palera1n
        unzip work/palera1n/palera1n.ipa -d work/palera1n/palera1n
        mkdir -p work/palera1n/palera1n/uwu/usr/local/bin/palera1nLoader.app
        cp -R work/palera1n/palera1n/Payload/palera1nLoader.app/* work/palera1n/palera1n/uwu/usr/local/bin/palera1nLoader.app
